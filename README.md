...
with $m_i,m_j$ the respective masses, $\lVert \vec{r}_{ij} \rVert$ the distance between $i$ and $j$, $\vec{r}_{ij}$ the distance vector and G the gravitationnal constant.
